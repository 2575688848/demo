package com.example.demo.ch4.config;

import com.example.demo.ch4.converter.DemoMessageConverter;
import com.example.demo.ch4.interceptor.DemoInterceptor;
...
@EnableWebMvc
@EnableScheduling
@ComponentScan("com.example.demo.ch4")
